...
class PhoneNumber {
  ...
  factory PhoneNumber.fromCompleteNumber({required String completeNumber}) {
    ...
    try {
      CountryModel country = getCountry(completeNumber);
      String number;
  ...
  static CountryModel getCountry(String phoneNumber) {
    if (phoneNumber == "") {
      throw NumberTooShortException();
    }
    ...
    return appCountries.firstWhere((country) => phoneNumber.startsWith(country.dialCode + country.regionCode));
  }
